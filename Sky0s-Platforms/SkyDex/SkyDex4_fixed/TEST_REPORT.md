...
- AI touchpoint detection now treats gate-routed lanes (`/api/ai-agent`, `/v1/chat`, `OMEGA_GATE_URL`, `KAIXU_APP_TOKEN`) as the expected pattern.
- CDE-native panel mode can be enabled through `?cde=1`.
