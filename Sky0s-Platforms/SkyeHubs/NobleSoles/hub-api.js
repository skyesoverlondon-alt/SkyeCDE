...
export function approveCaregiver(submissionId) {
  return api('/.netlify/functions/approve-caregiver', {
    method: 'POST',
...
export function createBooking(payload) {
  return api('/.netlify/functions/create-booking', {
    method: 'POST',
...
export function listBookings() {
  return api('/.netlify/functions/bookings', { method: 'GET' });
}

export function listBookingUpdates(bookingId) {
  return api(`/.netlify/functions/booking-updates?bookingId=${encodeURIComponent(bookingId)}`, { method: 'GET' });
}

export function postBookingUpdate(bookingId, note, photos) {
  return api('/.netlify/functions/booking-updates', {
    method: 'POST',
    body: JSON.stringify({ bookingId, note, photos }),
  });
}

export function listBookingMessages(bookingId) {
  return api(`/.netlify/functions/booking-messages?bookingId=${encodeURIComponent(bookingId)}`, { method: 'GET' });
}

export function postBookingMessage(bookingId, text) {
  return api('/.netlify/functions/booking-messages', {
    method: 'POST',
