...
exports.handler = async (event) => {
  try {
    ...
    await query(
      `
        INSERT INTO booking_requests (id, client_uid, client_email, request_type, payload, quote, status, source)
        VALUES ($1, $2, $3, $4, $5::jsonb, $6::jsonb, 'created_unpaid', 'noble_soul_request_web')
      `,
