// gateway-chat.js — local same-origin proxy to 0megaSkyeGate chat endpoint
//
// Allows browser/frontend to POST to /.netlify/functions/gateway-chat
// without hitting CORS. This function runs server-side and forwards to
// 0megaSkyeGate using KAIXU_APP_TOKEN as the Bearer token.
//
...
const UPSTREAM = () => `${GATE_BASE()}/v1/chat`;
