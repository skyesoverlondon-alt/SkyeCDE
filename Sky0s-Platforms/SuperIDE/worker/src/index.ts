...
function normalizeKaixuEndpoint(raw: string): string {
  ...
  // Redirect legacy skyesoverlondon.com URLs to 0megaSkyeGate (skyesol is decommissioned)
  if (/^https:\/\/skyesol\.netlify\.app/i.test(endpoint)) {
    return "https://0megaskyegate.skyesoverlondon.workers.dev";
  }
  return endpoint;
}
...
<body>
  <main>
    <section class="hero">
      ...
      <div class="cta-row">
        <a class="btn btn-primary" href="https://skyesoverlondon.com/kaixu/requestkaixuapikey" target="_blank" rel="noopener noreferrer">Request kAIxu Key</a>
        <a class="btn btn-ghost" href="https://skyesoverlondon.com/" target="_blank" rel="noopener noreferrer">Visit SkyesSOL</a>
      </div>
    </section>
    <div class="grid">
      <section class="card">
        ...
        <p>
          ...
          Site: <a href="https://skyesoverlondon.com/" target="_blank" rel="noopener noreferrer">skyesoverlondon.com</a>
        </p>
      </section>
      <section class="card">
        <h2>Get Access</h2>
        <p>
          ...
          Apply: <a href="https://skyesoverlondon.com/kaixu/requestkaixuapikey" target="_blank" rel="noopener noreferrer">Request kAIxu API Key</a>
        </p>
      </section>
      <section class="card">
        <h2>Health Probe</h2>
