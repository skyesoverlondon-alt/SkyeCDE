 ...
 * @param currentVersion - Current Skyes Over London version
...
function copyBundledPlugins(bundledPluginsDir, userPluginsDir, currentVersion) {
    ...
    if (!metadata) {
        ...
        console.log(`Skyes Over London updated from ${metadata.version} to ${currentVersion}. Updating built-in plugins...`);
        shouldCopy = true;
    }
